...
const messages = {
  ...
  success: {
    ...
    thankYouMessage:
      "Thank you for reaching out to us. Your inquiry has been received and we will get back to you within 24 hours.",
  ...
  error: {
    // Rate limiting
    rateLimitExceeded:
      "You have already submitted an inquiry today. We will get back to you within 24 hours.",
